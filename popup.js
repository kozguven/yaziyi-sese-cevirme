function Init() {
	var paused = false;
	var Render = function() {
		document.getElementById("pauseresume_img").src = chrome.extension.getURL(paused ? "img/play.png" : "img/pause.png");
	};
	...
	chrome.runtime.onMessage.addListener(function(request, sender, sendResponse) {
		if (request.utterance) {
		  narrate(request.utterance, function() { sendResponse("SesliMetin: OK"); });
		}
		Render();
	});
